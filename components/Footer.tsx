...
//                               <Info className="h-4 w-4 text-accent hover:text-accent/80 cursor-pointer transition-colors duration-200 text-[#EB993C]" />
//                             </button>
//                           </TooltipTrigger>
//                           <TooltipContent
//                             side="top"
//                             className="max-w-xs bg-white border-white"
//                           >
//                             <div className="text-sm whitespace-pre-line text-[#1F447B]">
  ...
  return (
    <footer id="footer" className="bg-white pt-8">
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom Bar moved to LegalBar component rendered in layout */}
      </div>
    </footer>
  );
}
